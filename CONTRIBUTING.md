...
This repository is mirrored on GitHub for use with Cursor. **All development
happens on GitLab** at
[gitlab.com/gitlab-org/developer-relations/cursor-gitlab-plugin](https://gitlab.com/gitlab-org/developer-relations/cursor-gitlab-plugin).

Please open issues and merge requests there. Pull requests and issues submitted
on GitHub will not be processed.
